...
export declare class StylesManager {
    ...
    static readonly overlayId: string;
    ...
    private static defaultTutorialOverlayStyles;
    ...
    static defaultTutorialOverlayStyle: CSSRules;
    ...
    static updateOverlaySize(overlay: HTMLElement): void;
    static revealOverlay(overlay: HTMLElement): void;
    static styleTutorialOverlay(overlay: HTMLElement): HTMLElement;
